...
<head>
    ...
    <title>{{ $title ?? 'ini default title'}}</title>
    <link href="{{ \Illuminate\Support\Facades\URL::asset('/css/app.css')}}" rel="stylesheet" />
    <link href="{{ \Illuminate\Support\Facades\URL::asset('/fontawesome6/css/all.css')}}" rel="stylesheet" />
...
<body>
    <header>
        <ul class="kiri">
            <li><svg class="block" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 62 62" focusable="false">
            ...
            <li> <a class="hitam" href="{{ route('site.index') }}">Menu</a> </li>
            <li> <a class="hitam" href="{{ route('site.index') }}">Rewards</a> </li>
            <li> <a class="hitam" href="{{ route('site.index') }}">Gift Card</a> </li>
        </ul>

        <ul class="kanan">
            <li> <a class="find hitam" href="{{ route('site.index') }}">Find a Store</a> </li>
            <li> <a class="sign-button" href="{{ route('site.index') }}">Sign In</a> </li>
            <li> <a class="join-button" href="{{ route('site.index') }}">Join Now</a></li>
        </ul>
    </header>
        ...
        <div class="sitemap">
            <div class="list">
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('site.index') }}">Stories and News</a></li>
                    <li> <a href="{{ route('site.index') }}">Starbucks Archive</a> </li>
                    <li> <a href="{{ route('site.index') }}">Investor Relations</a> </li>
                    <li> <a href="{{ route('site.index') }}">Customer Service</a></li>
                </ul>
            </div>
            ...
            <div class="list">
                <h3>Careers</h3>
                <ul>
                    <li> <a href="{{ route('site.index') }}">Culture and Values</a> </li>
                    <li> <a href="{{ route('site.index') }}">Inclusion, Diversity, and Equity</a> </li>
                    <li> <a href="{{ route('site.index') }}">College Achievement Plan</a></li>
                    <li> <a href="{{ route('site.index') }}">Alumni Community</a> </li>
                    <li> <a href="{{ route('site.index') }}">U.S. Careers</a> </li>
                    <li> <a href="{{ route('site.index') }}">International Careers</a></li>
                </ul>
            </div>
            ...
            <div class="list">
                <h3>Social Impact</h3>
                <ul>
                    <li> <a href="{{ route('site.index') }}">People</a> </li>
                    <li> <a href="{{ route('site.index') }}">Planet</a> </li>
                    <li> <a href="{{ route('site.index') }}">Evironmental and Social Impact Reporting</a></li>
                </ul>
            </div>
            ...
            <div class="list">
                ...
                <ul>
                    <li> <a href="{{ route('site.index') }}">Landlord Support Center</a> </li>
                    <li> <a href="{{ route('site.index') }}">Suppliers</a> </li>
                    <li> <a href="{{ route('site.index') }}">Corporate Gift Card Sales</a></li>
                    <li> <a href="{{ route('site.index') }}">Office and Foodservice Coffee</a></li>
                </ul>
            </div>
            ...
            <div class="list">
                ...
                <ul>
                    <li> <a href="{{ route('site.index') }}">Order on the App</a> </li>
                    <li> <a href="{{ route('site.index') }}">Order on the Web</a> </li>
                    <li> <a href="{{ route('site.index') }}">Delivery</a></li>
                    <li> <a href="{{ route('site.index') }}">Order and Pickup Options</a> </li>
                    <li> <a href="{{ route('site.index') }}">Explore and Find Coffee for Home</a></li>
                </ul>
            </div>
        </div>
